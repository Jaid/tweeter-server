...
```bash
npm install --global tweeter-server@^3.1.7
```
...
```bash
yarn global add tweeter-server@^3.1.7
```
...
```bash
npm install --global @jaid/tweeter-server@^3.1.7
```
