...
```bash
npm install --global tweeter-server@^3.1.4
```
...
```bash
yarn global add tweeter-server@^3.1.4
```
...
```bash
npm install --global @jaid/tweeter-server@^3.1.4
```
