...
```bash
npm install --global tweeter-server@^3.3.1
```
...
```bash
yarn global add tweeter-server@^3.3.1
```
...
```bash
npm install --global @jaid/tweeter-server@^3.3.1
```
